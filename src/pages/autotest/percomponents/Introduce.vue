  ...
  <div class="introduce">
    <ArrowContainer head-text="测试方案介绍">
      <div slot="content" class="test-introduce">
        <div class="title">APP UI 测试</div>
        <p>
          <i class="el-icon-news"></i>策略：执行特定的已录制好的用例脚本，运行期间，后台用adb打点收集APP相关的各种性能数据
        </p>
        <p>
          <i class="el-icon-news"></i>操作：先在手机安装测试APP，运行脚本执行特定场景的测试用例，最后产出性能报表
        </p>
        <p>
          <i class="el-icon-news"></i>建议：最好使用同一台手机的这次运行与上一次运行比较。
        </p>
      ...
      <div slot="content" class="test-process">
        <div class="introduce-image">
          <div class="introduce-item">
            <img
              src="http://ctsssource.oss-cn-shanghai.aliyuncs.com/monkey/static/resource/pic1.svg"
              alt
            >
          ...
          <div class="introduce-item">
            <img
              src="http://ctsssource.oss-cn-shanghai.aliyuncs.com/monkey/static/resource/arrow-right.svg"
              alt
            >
          </div>
          <div class="introduce-item">
            <img
              src="http://ctsssource.oss-cn-shanghai.aliyuncs.com/monkey/static/resource/pic2.svg"
              alt
            >
    ...
    <ArrowContainer head-text="测试报告">
      <div slot="content" class="test-introduce">
        <p>提供完整的性能测试报告，包括CPU、FPS、冷起动时间、热起动时间、页面打开时间等</p>
      </div>
    </ArrowContainer>
  </div>
</template>
    ...
    .introduce-image {
      ...
      .introduce-item {
        ...
        .special {
          width: 100%;
          height: 63px;
          background: url("http://ctsssource.oss-cn-shanghai.aliyuncs.com/monkey/static/resource/pic5.svg")
            no-repeat center;
